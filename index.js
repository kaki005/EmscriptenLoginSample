...
function prompt_name() { var result = prompt('Please input your name', ''); var stringPtr = allocate(intArrayFromString(result || ''), ALLOC_STACK); return stringPtr; }
function prompt_pass() { var result = prompt('Please input your password', ''); var stringPtr = allocate(intArrayFromString(result || ''), ALLOC_STACK); return stringPtr; }
...
// end include: preamble.js
  ...
  err('missing function: malloc'); abort(-1);
  }
...
var ___start_em_js = Module['___start_em_js'] = 79700;
var ___stop_em_js = Module['___stop_em_js'] = 80008;
